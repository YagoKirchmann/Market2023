 ...
 * @author aluno
 */
public class NewModelBuscar extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewModelBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewModelBuscar dialog = new NewModelBuscar(new javax.swing.JFrame(), true);
