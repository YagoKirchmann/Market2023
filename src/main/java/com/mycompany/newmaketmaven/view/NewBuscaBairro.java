 ...
 * @author aluno
 */
public class NewBuscaBairro extends javax.swing.JDialog {

    
    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaBairro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDadosAchados.setShowGrid(true);
        ...
        jPanelTituloLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                .addComponent(jLabelTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 49, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewModelBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaBairro dialog = new NewBuscaBairro(new javax.swing.JFrame(), true);
