 ...
 * @author aluno
 */
public class NewBuscaClasse extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaClasse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Buscar Classe");
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaClasse dialog = new NewBuscaClasse(new javax.swing.JFrame(), true);
