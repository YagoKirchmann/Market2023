 ...
 * @author aluno
 */
public class NewBuscaCondPgto extends javax.swing.JFrame {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaCondPgto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Buscar Condição de Pagamento");
        ...
        jTableDadosAchados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Numero de Parcelas", "Dias P/Primeira Parcela"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewBuscaCondPgto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewBuscaCondPgto().setVisible(true);
            }
        });
    }
