 ...
 * @author aluno
 */
public class NewBuscaCidade extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaCidade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Buscar Cidade");
     ...
     */
      public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaCidade dialog = new NewBuscaCidade(new javax.swing.JFrame(), true);
