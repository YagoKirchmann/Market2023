 ...
 * @author aluno
 */
public class NewBuscaProduto extends javax.swing.JFrame {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaProduto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Buscar Produto");
        ...
        jTableDadosAchados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Marca", "Código de Barras", "Data de Cadastro", "Status"
            }
        ) {
        ...
        jButtonSair.setIcon(new javax.swing.ImageIcon("C:\\Users\\aluno\\Documents\\Kirchmann\\Yago\\NewMarketMaven\\src\\test\\java\\imagens\\Forward.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewBuscaProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewBuscaProduto().setVisible(true);
            }
        });
    }
