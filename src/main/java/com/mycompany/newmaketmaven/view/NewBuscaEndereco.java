 ...
 * @author aluno
 */
public class NewBuscaEndereco extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaEndereco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Buscar Endereço");
        ...
        jTableDadosAchados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cidade", "Bairro", "Logradouro", "CEP"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewBuscaEndereco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaEndereco dialog = new NewBuscaEndereco(new javax.swing.JFrame(), true);
